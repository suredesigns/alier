...
class PersistentObject extends Singleton {
    ...
    //  initialize() invokes the given initializer and returns
    ...
    initialize(initializer) {
        return super.initialize(() => {
            ...
            this.#data_path  = `${class_name}`;
            //  Make the loaded property non-enumerable.
    ...
    save() {
        ...
        globalThis.localStorage.setItem(this.#data_path, JSON.stringify(this), true);
    }
    ...
    load() {
        // Access to localStorage 
        // Due to this, safely load saved data.
        
        const serialized_data = globalThis.localStorage.getItem(this.#data_path);
